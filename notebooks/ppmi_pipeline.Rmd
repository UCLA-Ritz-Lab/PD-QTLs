...
basedir<-paste(getwd(),'/../rawdata/PPMI_EPIC',sep='')
knitr::opts_knit$set(root.dir = basedir)
```

Under **../rawdata**, , save the following files into **PPMI/** directory::

- idat files from [PPMI repository](https://www.ppmi-info.org/access-data-specimens/download-data)

- the linkage file **ppmi_140_link_list_20210607.csv** and the covariate file **Participant_Status_16Jul2025.csv** from the [PPMI Box folder](https://app.box.com/folder/344303646736)
