...
Note that the top level directory where this Git repo is downloaded is denoted as [repo_root]. Under [repo_root], you should see directories such as docs, rawdata, and bin.

## Obtain raw files from UCLA Box folder.

	Contact garychen@ucla.edu for access info.

# Download methylome data imputed from 450k to EPIC v2 microarray using PPMI samples as the reference panel.  Location:

	https://app.box.com/folder/343612249565

# Download genotype data imputed using HRC reference panel. Location:

	https://app.box.com/folder/343611810704
